...
public class HttpResponseHandler extends SimpleChannelInboundHandler<FullHttpResponse> {
	...
	public HttpResponseHandler() {
		// Use a concurrent map because we add and iterate from the main thread (just
		// for the purposes of the example),
		// but Netty also does a get on the map when messages are received in a
		// EventLoop thread.
	 ...
	 * @param unit
	 *            Units associated with {@code timeout}
	 * @see HttpResponseHandler#put(int, io.netty.channel.ChannelFuture,
